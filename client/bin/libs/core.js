...
(function() {
  var Player, cancelNotification, host, hostJSON, loginSuccess, showNotification, successJSON, updateNames,
    _this = this;
  ...
  this.callback.startGame = function(data) {
    ...
    this.callback.renderState(data.others);
  ...
  game.setCards = function(data) {
    ...
    cards = (function() {
      ...
      for (_i = 0, _len = data.length; _i < _len; _i++) {
        card = data[_i];
        _results.push("<div class=\"card-border\" id=\"card-border-" + (++i) + "\"><div class=\"card\" id=\"card-" + i + "\"><img src=\"/cards/" + card + ".png\"></div></div>");
      }
      return _results;
    })();
    cards.join(' ');
