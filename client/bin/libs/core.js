...
(function() {
  var cancelNotification, host, hostJSON, showNotification, successJSON, updateNames,
    _this = this,
  ...
  successJSON = function(data) {
    ...
    if (method in _this.callback) {
      ...
      _this.notify("Unknown answer from server.", 2500, notify.error);
      return false;
    }
  };
  ...
  this.callback.refreshNames = function(data) {
    ...
    if (data) {
      ...
      names = typeof namesList !== "undefined" && namesList !== null ? namesList.join(' ') : void 0;
      if (names != null) {
  ...
  this.callback.loginSuccess = function(data) {
    _this.userID = data;
    _this.loadContent("/lobby.html");
    return _this.callback.refreshNames();
  };
